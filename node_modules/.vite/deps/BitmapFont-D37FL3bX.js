...
import { A as DOMAdapter, G as TextureStyle, Q as v8_0_0, R as warn, V as Texture, Z as deprecation, it as Matrix, lt as eventemitter3_default, nt as Rectangle, rt as groupD8, tt as uid, z as Color } from "./Geometry-B9VM7gO4.js";
import { r as ImageSource, t as canvasUtils } from "./canvasUtils-Dh8VgcYH.js";
import { t as Cache } from "./Cache-DtbCh3fV.js";
import { M as FillGradient, a as FillPattern, i as toStrokeStyle, r as toFillStyle, t as GraphicsContext } from "./GraphicsContext-CNvX-P8y.js";
	...
	for (let i = 0; i < chars.length + 1; i++) {
		...
		if (/(?:\s)/.test(char) || char === "\r" || char === "\n" || isEnd) {
			if (!firstWord && style.wordWrap && checkIsOverflow(currentLine.width + currentWord.width)) {
				...
				if (!isEnd && charData) currentLine.charPositions.push(0);
			} else {
